...
11. Architecture MUST be enterprise and clean, modular monolith Floovioo with branded products that each has many faetures that implement, combine and depend on other tools and services within the platform.