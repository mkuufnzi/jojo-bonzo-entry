...
BEFORE WRITING NEW CODE, SCAN THE CODEBASE FOR EXISTING SOLUTIONS 
IF YOU SUSPECT THAT YOU MY HAVE WRITE CODE THAT GIVEN THE STATE OF THE CODEBASE AND THE EXTENSIVCE, ENTERRISE NATURE OF THE CODEBASE, IS LIKEY TO HAVE BEEN IMPLEMENTED OR SCAFFOLDED , SCAN THE ARCHITECTURE FOLDER TREE AND NOTE THEM AND NOTE THE OLD VS NEW CODE FOR LATER ACTION
***design with mobile-first responsive design everywher***