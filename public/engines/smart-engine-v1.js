...
function smartInvoice() {
    return {
        ...
        nurtureMessages: window.DOC_DATA.features?.marketing_banner || window.DOC_DATA.features?.product_support || [],
        ...
        init() {
             ...
             // Auto-expand first tutorial for better visibility in static previews
